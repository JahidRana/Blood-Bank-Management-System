...
$username = $password = $phone = $confirm_password = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($username_err) && empty($phone_err)  && empty($password_err) && empty($confirm_password_err)) {
        ...
        $sql = "INSERT INTO users (phone,username, password) VALUES (?, ?,?)";

        if ($stmt = mysqli_prepare($link, $sql)) {

            mysqli_stmt_bind_param($stmt, "sss", $param_phone, $param_username, $param_password);
